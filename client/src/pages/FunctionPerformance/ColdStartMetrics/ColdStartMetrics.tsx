...
const ColdStartsMetricsContainer = ({ data }: Props) => {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-[2fr_1fr_1fr_1fr] gap-2.5 px-4 py-2.5 bg-[#e1e1e1] dark:bg-[#2a2a2a] text-[#646464] dark:text-[#a2a2a2] text-sm tracking-wide transition-colors">
